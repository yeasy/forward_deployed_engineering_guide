...
截至 2026-05-19，Linux Foundation 公开信息显示 MCP 已作为 Agentic AI Foundation 的 founding project 接收，官方 MCP 社区也维护治理说明；这说明协议治理正在走向中立化，但不代表任意 MCP server 可直接进入生产。FDE 应把 MCP server 当作供应链资产：记录来源、版本、签名、工具 schema、权限范围、网络访问、数据外发、依赖 SBOM、运行身份和禁用开关。
