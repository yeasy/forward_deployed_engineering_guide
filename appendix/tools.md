...
[Microsoft Foundry](https://learn.microsoft.com/azure/ai-foundry/)（原 Azure AI Foundry，2025-11 更名）在 Azure 上集成模型目录、agent、评测与责任 AI 工具，适合已在 Microsoft 生态、需要私网与合规审计的客户。
